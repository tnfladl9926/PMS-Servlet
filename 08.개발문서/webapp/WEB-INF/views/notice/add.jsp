...
<body>
  <div id="container">
        ...
        <div id="content">
            ...
            <h2 class="subtitle">공지사항 등록</h2>
        
        
        	<form method="POST" action="/pms/notice/noticeAdd.do">
            <table class="listtbl">
                <tr>
                    <th>제목</th>
                ...
                <tr>
                    <th>부서</th>
                    <td>
                   	<input type="text" name="noticetype">
                  </td>
                </tr>
            </table>
            ...
            <div style="text-align: center;">
					<input type="submit" name="btn1" id="btn1" class="btn btnAdd" value="등록" onclick="location.href='/pms/notice/noticelist.do';">
                  <input type="button" name="btn2" id="btn2" class="btnred" value="취소" onclick="location.href='/pms/notice/noticelist.do';" >
