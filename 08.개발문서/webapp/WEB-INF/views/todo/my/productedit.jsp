...
<body>
	<div id="container">
        ...
        <div id="content">
            ...
            <form method="POST" action="/pms/todo/my/productedit.do">
            <table class="listtbl">
                <tr>
                    <th>프로젝트명</th>
                    <td colspan="3">
                ...
                <tr>
                    <th>산출물명</th>
                    <td><input type="text" name="product" class="txt1" value="${dto.prname}"></td>
                    <th>작성자</th>
                    <td>${dto.emname}</td>
                </tr>
                <tr>
                    <th>등록날짜</th>
                    <td><input type="date" name="date" class="txt1" value="${dto.prdate}"></td>
                    <th>파일</th>
                    <td><input type="file" name="file" class="txt1" value="파일.txt"></td>
                </tr>
            </table>
            ...
            <table class="listtbl" style="margin-top: 0;">
                <tr>
                    ...
                    <td colspan="3"><textarea name="content">${dto.content}</textarea></td>
                </tr>
            </table>
            ...
            <div style="text-align: center;">
                ...
                <button type="button" class="btn" style="display :inline-block;" onclick="location.href='/pms/todo/my/productdetail.do?seq=${dto.prseq}';">취소</button>
            </div>
            </form>
        </div>
    </div>
