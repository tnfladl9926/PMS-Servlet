        ...
        <div id="content">
            ...
            <table class="listtbl">
                ...
                <tr>
                    ...
                    <td>${dto.prdate}</td>
                    <th>파일 다운로드</th>
                    <td><a href="/pms/asset/productfiles/${dto.file}" download>${dto.file} </a></td>
                </tr>
            </table>
            ...
            <div style="text-align: center;">
                <button type="submit" class="btn" style="display :inline-block;" onclick="location.href='/pms/todo/my/productedit.do?seq=${dto.prseq}';">수정</button>
                <button type="button" class="btn" style="display :inline-block;" onclick="location.href='/pms/todo/my/productlist.do';">목록</button>
                <button class="btnred" style="display :inline-block;" onclick="location.href='/pms/todo/my/productdel.do?seq=${dto.prseq}';">삭제</button>
            </div>
        </div>
    </div>
