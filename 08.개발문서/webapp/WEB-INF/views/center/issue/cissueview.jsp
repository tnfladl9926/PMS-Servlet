        ...
        <div id="content">
            ...
            <table class="listtbl" style="margin-top: 0;">
                <tr>
                    ...
                    <td colspan="3"><textarea readonly>${dto.issuecontent}</textarea></td>
                </tr>
            </table>
            	<%-- </c:forEach> --%>

            <div style="text-align: center;">
                <button class="btn" style="display :inline-block;" onclick="location.href='/pms/center/issue/cissuelist.do?pjseq=${dto.projectseq}'">목록</button>
            </div>
