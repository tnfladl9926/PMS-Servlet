...
<body>
    <div id="container">
        ...
        <div id="content">
            ...
            <h2 class="subtitle">버전 목록</h2>
			
			
			<c:if test="${lv} eq '2'"> 
			<button type="button" class="btn"
				onclick="location.href='/pms/center/version/versionadd.do?projectseq=${projectseq}'">등록하기
			</button>
			</c:if> 
            ...
            <table class="listtbl">
                ...
                <c:forEach items="${vslist}" var="dto">
                <tr>
                    <td>${dto.version}</td>
                    <td>
                    <a href="/pms/center/version/versiondetail.do?projectseq=${dto.projectseq}&versionseq=${dto.versionseq}">
                    	${dto.projectname}
                    </a>
                    </td>
