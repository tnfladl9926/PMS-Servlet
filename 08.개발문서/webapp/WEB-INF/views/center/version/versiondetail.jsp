...
download
            ...
            <div style="text-align: center;">
                ...
                <button class="btn-red" style="display :inline-block;" onclick="location.href='/pms/center/version/versiondel.do?projectseq=${dto.projectseq}&versionseq=${dto.versionseq}';">삭제</button>
            </div>
